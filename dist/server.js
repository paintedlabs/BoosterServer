...
class MtgJsonApiDataSource {
    constructor(data) {
        ...
        if (!data || !data.allPrintings) {
            throw new Error('Cannot initialize MtgJsonApiDataSource with null loadedData or allPrintings');
        }
...
async function main() {
    ...
    try {
        ...
        // !loadedData.combinedCards
            ...
            logger_1.default.fatal('Essential data structures (esp. allPrintings) failed to load.');
            throw new Error('Essential data structures (esp. allPrintings) failed to load.');
        }
        // At this point, loadedData and loadedData.allPrintings are guaranteed non-null
        const nonNullLoadedData = loadedData;
        ...
        (0, imageCacheService_1.initializeImageCacheService)(app, nonNullLoadedData);
        // 3. Mount API Routers
