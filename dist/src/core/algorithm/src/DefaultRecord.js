...
exports.createDefaultRecord = void 0;
 ...
 */
const createDefaultRecord = (initialValue, defaultValueFactory) => typesafety.stampBrand(new Proxy(initialValue, {
    get(target, property) {
        if (Reflect.has(target, property)) {
            return Reflect.get(target, property);
        }
        const defaultValue = defaultValueFactory(property);
        Reflect.set(target, property, defaultValue);
        return defaultValue;
    },
}));
exports.createDefaultRecord = createDefaultRecord;
