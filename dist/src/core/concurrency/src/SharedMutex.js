...
const createSharedMutex = () => {
    ...
    const runShared = (runner) => __awaiter(void 0, void 0, void 0, function* () {
        const lock = yield acquireSharedLock();
        try {
            return yield runner();
        }
        finally {
    ...
    const runExclusive = (runner) => __awaiter(void 0, void 0, void 0, function* () {
        const lock = yield acquireExclusiveLock();
        try {
            return yield runner();
        }
        finally {
