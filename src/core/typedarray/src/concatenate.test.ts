...
describe('concatUint8Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateUint8Array([])).toStrictEqual(
      new Uint8Array(0),
    );
  });
  ...
  it('Can concatenate Uint8Array.', () => {
    expect(
      typedarray.concatenateUint8Array([
...
describe('concatUint8ClampedArray', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateUint8ClampedArray([])).toStrictEqual(
  ...
  it('Can concatenate Uint8ClampedArray.', () => {
    expect(
      typedarray.concatenateUint8ClampedArray([
...
describe('concatUint16Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateUint16Array([])).toStrictEqual(
      new Uint16Array(0),
    );
  });
  ...
  it('Can concatenate Uint16Array.', () => {
    expect(
      typedarray.concatenateUint16Array([
...
describe('concatUint32Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateUint32Array([])).toStrictEqual(
      new Uint32Array(0),
    );
  });
  ...
  it('Can concatenate Uint32Array.', () => {
    expect(
      typedarray.concatenateUint32Array([
...
describe('concatInt8Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateInt8Array([])).toStrictEqual(
      new Int8Array(0),
    );
  });
  ...
  it('Can concatenate Int8Array.', () => {
    expect(
      typedarray.concatenateInt8Array([
        Int8Array.of(-100, -50),
        Int8Array.of(0),
        Int8Array.of(50, 100),
      ]),
...
describe('concatInt16Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateInt16Array([])).toStrictEqual(
      new Int16Array(0),
    );
  });
  ...
  it('Can concatenate Int16Array.', () => {
    expect(
      typedarray.concatenateInt16Array([
...
describe('concatInt32Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateInt32Array([])).toStrictEqual(
      new Int32Array(0),
    );
  });
  ...
  it('Can concatenate Int32Array.', () => {
    expect(
      typedarray.concatenateInt32Array([
...
describe('concatFloat32Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateFloat32Array([])).toStrictEqual(
      new Float32Array(0),
    );
  });
  ...
  it('Can concatenate Float32Array.', () => {
    expect(
      typedarray.concatenateFloat32Array([
...
describe('concatFloat64Array', () => {
  it('Returns an empty buffer when no buffers are provided.', () => {
    expect(typedarray.concatenateFloat64Array([])).toStrictEqual(
      new Float64Array(0),
    );
  });
  ...
  it('Can concatenate Float64Array.', () => {
    expect(
      typedarray.concatenateFloat64Array([
